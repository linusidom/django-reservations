...
(function(){
	...
	window.App={monthData:[],defaults:{},init:function(){
		this.calendar=new Calendar($("#calendar"));
		new Month(this.calendar.month+1,this.calendar.year);
		new Reservation(this.calendar.year);
		return new Holidays(this.calendar.year);},renderTime:function(){
			var hh,nn,now;now=new Date();
			hh=now.getHours();
			nn="0"+now.getMinutes();
	...
	AjaxModel=(function(){
		...
		Month=(function(){
			...
			function Month(month,year){
				...
				that=this;
				$.ajax({
					url:'month/'+this.month+'/'+this.year,success:function(data){
		...
		Calendar=(function(){
			...
			Calendar.prototype.renderError=function(fieldName,text){
				...
				error_desc.innerHTML=text;container.classList.remove("success");
